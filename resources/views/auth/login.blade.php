        ...
        <div class="navbar-nav ms-auto py-0">
          ...
          <div class="nav-item dropdown">
            ...
            <div class="dropdown-menu m-0">
              ...
              <!-- <a href="/maps" class="dropdown-item active">Maps</a> -->
              <a href="/package" class="dropdown-item">Packages</a>
            </div>
          </div>
...
{{--                  <x-application-logo class="w-20 h-20 fill-current text-gray-500" />--}}
                  <p style="font-size: 2rem; font-weight: bolder; padding-bottom: 5vw; text-align: justify-all">Please login to use our services</p>
          </x-slot>
      ...
      <div class="row g-5">
        ...
        <div class="col-lg-3 col-md-6">
          ...
          <div class="position-relative mx-auto" style="max-width: 400px">
            ...
            <a href="/WEB-Project/signUp.html" type="button"
